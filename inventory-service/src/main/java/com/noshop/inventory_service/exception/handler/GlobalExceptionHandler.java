...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({DuplicateInventoryException.class, DuplicateWarehouseException.class, InsufficientStockException.class, InactiveWarehouseException.class, InvalidInventoryOperationException.class, DataIntegrityViolationException.class})
    ...
    public ErrorResponse handleRequestValidation(MethodArgumentNotValidException ex,
                                                 HttpServletRequest request) {
